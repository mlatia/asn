...
export function QuizPanel() {
  ...
  return (
    <aside className="w-full md:w-[320px] p-6 bg-white dark:bg-gray-800 shadow-sm rounded-lg flex flex-col gap-6 self-start">
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="w-full text-sm text-[#4D4D4B] dark:text-gray-400">
          ...
          <Progress
            ...
            className="h-2 [&::-webkit-progress-bar]:bg-gray-200 [&::-webkit-progress-value]:bg-primary-blue"
          />
        </div>
      </div>

      <div className="flex-1 overflow-y-auto quiz-content-scroll pr-2">
        {" "}
        <h3 className="text-lg font-semibold mb-4 text-primary-dark">Daftar Soal</h3>
      ...
      <Button
        onClick={finishQuiz}
        disabled={quizFinished}
        className="w-full rounded-full py-2 bg-primary-blue hover:bg-primary-blue-dark text-white"
      >
        Selesai
      </Button>
    </aside>
